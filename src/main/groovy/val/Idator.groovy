 ...
 *
 * Idators will normally create a structure aligned with the expected input graph where each
 * Idator will similarly be composed of those beneath it with a single DefinitionCheck attached to
