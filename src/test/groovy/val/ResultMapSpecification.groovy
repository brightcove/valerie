...
class ResultMapImmutabilitySpecification extends Specification {
    ...
    def 'modifying the Map argument after construction does not modify the object'() {
        given:
    ...
    def 'modifying a Map argument value List after construction does not modify the object'() {
        given:
    ...
    def 'attemps to modify the returned Map throw UnsupportedOperationException'() {
        given:
    ...
    def 'attempts to modify a List within the returned Map throw UnsupportedOperationException'() {
        given:
        ResultMap resultMap = ResultMap.from(foo: [new Result('foo', 'foo')])
...
class ResultMapResusedObjectsSpecification extends Specification {
...
class ResultMapOperatorSpecification extends Specification {
